...
l'échantillon. Les chapitres~\ref{chap:estimation} et~\ref{chap:tests} traitent
...
Étant données $n$ {observations} $\{x_i\}_{i=1, \dots, n}$ appartenant à un
espace $\XX$, et leurs {étiquettes} $\{y_i\}_{i=1, \dots, n}$ appartenant à un
