...
\item Une autre façon de voir la régularisation est de considérer qu'il s'agit
  ...
  risque empirique régularisé par la norme $\ell_12$ est équivalente à
  l'estimation bayésienne avec un \textit{a priori} gaussien sur les
  coefficients du modèle, et la minimisation du risque empirique régularisé par
  la norme $\ell_1$ est équivalente à l'estimation bayésienne avec un \textit{a
