...
et une variable qualitative (âge par tranches). Cf. figure 2.7.\newline
...
figures 2.6(\textsc{C}) $(r=0,50)$ et 2.6(\textsc{D}) $(r=1,00)$. Une corrélation de $0,95$
serait plus proche de la figure 2.6(\textsc{D}) que de celle donnée ci-dessus.
\end{minipage}%
}%
